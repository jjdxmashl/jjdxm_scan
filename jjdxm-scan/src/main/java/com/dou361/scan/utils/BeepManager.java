...
public class BeepManager implements MediaPlayer.OnCompletionListener,
    ...
    public synchronized void updatePrefs() {
        ...
        vibrate = prefs.getBoolean(CameraConfig.KEY_VIBRATE, true);
    ...
    private static boolean shouldBeep(SharedPreferences prefs, Context activity) {
        boolean shouldPlayBeep = prefs.getBoolean(CameraConfig.KEY_PLAY_BEEP, true);
        if (shouldPlayBeep) {
    ...
    public void onCompletion(MediaPlayer mp) {
        // When the jjdxm_scan_beep has finished playing, rewind to queue up another one.
        mp.seekTo(0);
    }
