...
final class DecodeHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        int id = message.what;
        if (id == ResourceUtils.getResourceIdByName(activity, "id", "decode")) {
            decode((byte[]) message.obj, message.arg1, message.arg2);
        } else if (id == ResourceUtils.getResourceIdByName(activity, "id", "quit")) {
            running = false;
        ...
        if (rawResult != null) {
            ...
            if (handler != null) {
                Message message = Message.obtain(handler,
                        ResourceUtils.getResourceIdByName(activity, "id", "decode_succeeded"), rawResult);
            ...
            if (handler != null) {
                Message message = Message.obtain(handler, ResourceUtils.getResourceIdByName(activity, "id", "decode_failed"));
                message.sendToTarget();
            }
        }
    }
