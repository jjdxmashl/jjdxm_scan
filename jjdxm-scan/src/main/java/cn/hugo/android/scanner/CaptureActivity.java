...
public final class CaptureActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ResourceUtils.getResourceIdByName(mContext, "capture", ""));
        ...
        // 监听图片识别按钮
        findViewById(ResourceUtils.getResourceIdByName(mContext, "id", "capture_scan_photo")).setOnClickListener(this);

        findViewById(ResourceUtils.getResourceIdByName(mContext, "id", "capture_flashlight")).setOnClickListener(this);
    ...
    protected void onResume() {
        ...
        viewfinderView = (ViewfinderView) findViewById(ResourceUtils.getResourceIdByName(mContext, "id", "capture_viewfinder_view"));
        ...
        SurfaceView surfaceView = (SurfaceView) findViewById(ResourceUtils.getResourceIdByName(mContext, "id", "capture_preview_view")); // 预览
    ...
    protected void onPause() {
        ...
        if (!hasSurface) {
            SurfaceView surfaceView = (SurfaceView) findViewById(ResourceUtils.getResourceIdByName(mContext, "id", "capture_preview_view"));
            SurfaceHolder surfaceHolder = surfaceView.getHolder();
    ...
    public void restartPreviewAfterDelay(long delayMS) {
        if (handler != null) {
            handler.sendEmptyMessageDelayed(ResourceUtils.getResourceIdByName(mContext, "id", "restart_preview"), delayMS);
        }
        resetStatusView();
    }
        ...
        if (handler == null) {
            ...
            if (savedResultToShow != null) {
                Message message = Message.obtain(handler,
                        ResourceUtils.getResourceIdByName(mContext, "id", "decode_succeeded"), savedResultToShow);
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setTitle(getString(ResourceUtils.getResourceIdByName(mContext, "string", "app_name")));
        builder.setMessage(getString(ResourceUtils.getResourceIdByName(mContext, "string", "msg_camera_framework_bug")));
        builder.setPositiveButton(ResourceUtils.getResourceIdByName(mContext, "string", "button_ok"), new FinishListener(this));
